...
int test_jsmn_test_suite_n_(void) {
  ...
  check(query("[1e1�]", JSMN_ERROR_INVAL));
  ...
  check(query("[1e�]", JSMN_ERROR_INVAL));
  ...
  check(query("[１]", JSMN_ERROR_INVAL));
  ...
  check(query("[é]", JSMN_ERROR_INVAL));
  ...
  check(query("aå", JSMN_ERROR_INVAL));
